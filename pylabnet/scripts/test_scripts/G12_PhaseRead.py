...
CFG_DIR = Path(r"C:\\Users\\user\\pylabnet\\pylabnet\\configs")
...
pulse_var_dict_G12 = load_local_config('pulse_vars')
dio_dict_G12 = load_local_config('dio_assignment_global')
