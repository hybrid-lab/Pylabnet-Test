# PGC Bias Z sweep with full cooling sequence.
# Full sequence: MOT -> CMOT -> Dark MOT -> PGC -> release -> TOF(15ms) -> image
# Sweep ao10 (Bias Z) from 0 to 1V in 10 points.
...
INIT_DICT = {
    ...
    'bias_2_v': {'Bias Z 2 (V)': '0.111'},
    'bias_3_v': {'Bias Z 3 (V)': '0.222'},
    'bias_4_v': {'Bias Z 4 (V)': '0.333'},
    'bias_5_v': {'Bias Z 5 (V)': '0.444'},
    'bias_6_v': {'Bias Z 6 (V)': '0.556'},
    'bias_7_v': {'Bias Z 7 (V)': '0.667'},
    'bias_8_v': {'Bias Z 8 (V)': '0.778'},
    'bias_9_v': {'Bias Z 9 (V)': '0.889'},
    'bias_10_v': {'Bias Z 10 (V)': '1.000'},
...
def experiment(**kwargs):
    ...
    total = len(cam_p)
    logger.info(f"PGC Bias Z sweep: values={bias_values_v}V, tof={tof_us}us, total={total} samples")
