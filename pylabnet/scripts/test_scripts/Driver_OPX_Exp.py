...
def experiment(**kwargs):
    ...
    while thread.running:
        ...
        dataset.OPX_client.set_ao_voltage("const", dataset.get_input_parameter('input_channel'), dataset.get_input_parameter('output_voltage'))
        data_batch = dataset.OPX_client.get_ai_voltage(1, 112)
