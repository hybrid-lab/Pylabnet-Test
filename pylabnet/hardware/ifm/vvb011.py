...
class Driver:
    ...
    def __init__(self, device_name='VVB011', host='192.168.50.238', port=3, logger=None, dummy=False):
        """Instantiate IFM's vibration sensor
        ...
        r0 = requests.post(self.IP, json=body)
    ...
    def response_handler(self, response, display=True):
        ...
        return v_rms, a_peak, a_rms, crest, temperature
